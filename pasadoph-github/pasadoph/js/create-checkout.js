...
exports.handler = async function (event) {
  try {
    ...
    var allowed = [
      "https://pasadophreviewer.com",
      "https://www.pasadophreviewer.com",
      "https://pasadoph-reviewer.netlify.app"
    ];
    var origin = String(body.origin || "");
    var site = allowed.indexOf(origin) >= 0 ? origin : "https://pasadophreviewer.com";
